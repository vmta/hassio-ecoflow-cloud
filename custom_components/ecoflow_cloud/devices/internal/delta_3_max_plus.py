...
from custom_components.ecoflow_cloud.devices.internal.proto import (
    ef_delta_3_max_plus_pb2 as delta_3_max_plus_pb2,
)
...
class Delta3MaxPlusCommandMessage(PrivateAPIMessageProtocol):
    """Message wrapper for Delta 3 Max Plus protobuf commands."""

    def __init__(
        self,
        payload: delta_3_max_plus_pb2.Delta3MaxPlusSetCommand,
        packet: delta_3_max_plus_pb2.Delta3MaxPlusSendHeaderMsg,
    ):
        self._packet = packet
...
def _create_delta_3_max_plus_proto_command(field_name: str, value: int, device_sn: str, data_len: int | None = None):
    """Create a protobuf command for Delta 3 Max Plus."""
    # Build the command using the generated protobuf class
    payload = delta_3_max_plus_pb2.Delta3MaxPlusSetCommand()
    try:
        setattr(payload, field_name, int(value))
    except AttributeError:
        _LOGGER.error("Unknown Delta3MaxPlus set field: %s", field_name)
        return None
    ...
    return Delta3MaxPlusCommandMessage(payload, packet)


def _create_delta_3_max_plus_energy_backup_command(energy_backup_en: int | None, energy_backup_start_soc: int, device_sn: str):
    """Create a protobuf command for Delta 3 Max Plus energy backup settings."""
...
class Delta3MaxPlusChargingStateSensorEntity(BaseSensorEntity):
...
class Delta3MaxPlus(BaseInternalDevice):
    """EcoFlow Delta 3 Max Plus device implementation using protobuf decoding."""
    ...
    def sensors(self, client: EcoflowApiClient) -> list[SensorEntity]:
        return [
            ...
            #
            Delta3MaxPlusChargingStateSensorEntity(client, self, "bms_chg_dsg_state", const.BATTERY_CHARGING_STATE),
            #
            InEnergySolarSensorEntity(client, self, "pv_in_energy", const.SOLAR_1_IN_ENERGY), False,
            InEnergySolarSensorEntity(client, self, "pv2_in_energy", const.SOLAR_2_IN_ENERGY, False),
            InMilliampSensorEntity(client, self, "plug_in_info_pv_amp", const.SOLAR_1_IN_AMPS, False),
            InMilliampSensorEntity(client, self, "plug_in_info_pv2_dc_amp_max", const.SOLAR_2_IN_AMPS, False),
            InMilliampSensorEntity(client, self, "plug_in_info_pv2_chg_amp_max", const.SOLAR_IN_CURRENT, False),
            InVoltSensorEntity(client, self, "plug_in_info_pv2_chg_vol_max", const.SOLAR_2_IN_VOLTS, False),
            ...
            InWattsSensorEntity(client, self, "pow_get_pv", const.SOLAR_1_IN_POWER, False),
            InWattsSensorEntity(client, self, "pow_get_pv2", const.SOLAR_2_IN_POWER, False),
            InWattsSensorEntity(client, self, "pow_in_sum_w", const.TOTAL_IN_POWER).with_energy(),
            # InWattsSensorEntity(client, self, "pow_get_l1", "L1 Input Power"),
            # InWattsSensorEntity(client, self, "pow_get_l2", "L2 Input Power"),
            #
            LevelSensorEntity(client, self, "bms_batt_soc", const.MAIN_BATTERY_LEVEL, False),
            ...
            OutWattsAbsSensorEntity(client, self, "pow_get_12v", const.DC_OUT_POWER),
            OutWattsAbsSensorEntity(client, self, "pow_get_ac_out", const.AC1_OUT_POWER),
            OutWattsAbsSensorEntity(client, self, "pow_get_ac2_out", const.AC2_OUT_POWER),
            # OutWattsAbsSensorEntity(client, self, "pow_get_dc", const.DC_CAR_OUT_POWER),
            # OutWattsAbsSensorEntity(client, self, "pow_get_dcp", const.DC_CAR_OUT_POWER),
            ...
            OutWattsAbsSensorEntity(client, self, "pow_get_typec2", const.TYPEC_2_OUT_POWER),
    ...
    def numbers(self, client: EcoflowApiClient) -> list[NumberEntity]:
        ...
        return [
            MaxBatteryLevelEntity(
                ...
                50,
                100,
                lambda value: _create_delta_3_max_plus_proto_command("cmsMaxChgSoc", int(value), device.device_data.sn),
            ),
            MinBatteryLevelEntity(
                client,
                self,
                ...
                0,
                30,
                lambda value: _create_delta_3_max_plus_proto_command("cmsMinDsgSoc", int(value), device.device_data.sn),
            ),
            ChargingPowerEntity(
                client,
                self,
                ...
                200,
                2400,
                lambda value: _create_delta_3_max_plus_proto_command("plugInInfoAcInChgPowMax", int(value), device.device_data.sn),
            ),
            BatteryBackupLevel(
                client,
                self,
                ...
                "cms_max_chg_soc",
                5,
                lambda value: _create_delta_3_max_plus_energy_backup_command(1, int(value), device.device_data.sn),
            ),
        ]
    ...
    def switches(self, client: EcoflowApiClient) -> list[SwitchEntity]:
        ...
        return [
            BeeperEntity(
                ...
                "en_beep",
                const.BEEPER,
                lambda value: _create_delta_3_max_plus_proto_command(
            ...
            EnabledEntity(
                ...
                "cfg_ac_out_open",
                const.AC_ENABLED,
                lambda value, params=None: _create_delta_3_max_plus_proto_command(
            ...
            EnabledEntity(
                ...
                "energy_backup_en",
                const.BP_ENABLED,
                lambda value, params=None: _create_delta_3_max_plus_energy_backup_command(
    ...
    def selects(self, client: EcoflowApiClient) -> list[SelectEntity]:
        ...
        return [
            ...
            TimeoutDictSelectEntity(
                ...
                lambda value: _create_delta_3_max_plus_proto_command("screenOffTime", int(value), device.device_data.sn),
            ),
            TimeoutDictSelectEntity(
                client,
                self,
                ...
                lambda value: _create_delta_3_max_plus_proto_command("devStandbyTime", int(value), device.device_data.sn),
            ),
            TimeoutDictSelectEntity(
                client,
                self,
                ...
                lambda value: _create_delta_3_max_plus_proto_command("acStandbyTime", int(value), device.device_data.sn),
            ),
            TimeoutDictSelectEntity(
                client,
                self,
                ...
                lambda value: _create_delta_3_max_plus_proto_command("dcStandbyTime", int(value), device.device_data.sn),
            ),
        ]

    @override
    def _prepare_data(self, raw_data: bytes) -> dict[str, Any]:
        """Prepare Delta 3 Max Plus data by decoding protobuf and flattening fields."""
        ...
        try:
            ...
            _LOGGER.debug(f"[Delta3MaxPlus] Data processing failed: {e}")
            return super()._prepare_data(raw_data)
    ...
    def _decode_header_message(self, raw_data: bytes) -> dict[str, Any] | None:
        ...
        try:
            ...
            try:
                ...
                _LOGGER.debug("[Delta3MaxPlus] base64 decode failed, proceeding with raw data")

            try:
                header_msg = delta_3_max_plus_pb2.Delta3MaxPlusHeaderMessage()
                header_msg.ParseFromString(raw_data)
            except Exception as e:
                _LOGGER.debug("[Delta3MaxPlus] Failed to parse header message: %s", e)
                return None
            ...
            _LOGGER.debug("[Delta3MaxPlus] Failed to decode header message: %s", e)
            return None
    ...
    def _extract_payload_data(self, header_obj: Any) -> bytes | None:
        ...
        try:
            ...
            _LOGGER.debug("[Delta3MaxPlus] Failed to extract payload data: %s", e)
            return None
        ...
        try:
            if cmd_func == 254 and cmd_id == 21:
                ...
                try:
                    ...
                    _LOGGER.debug(f"Failed to decode as Delta3MaxPlusSetReply: {e}")
                    return {}

            elif cmd_func == 32 and cmd_id == 2:
                try:
                    msg_cms_heartbeat = delta_3_max_plus_pb2.Delta3MaxPlusCMSHeartBeatReport()
                    msg_cms_heartbeat.ParseFromString(pdata)
                    return self._protobuf_to_dict(msg_cms_heartbeat)
                except Exception as e:
                    _LOGGER.debug(f"Failed to decode as Delta3MaxPlusCMSHeartBeatReport: {e}")
                    return {}

            elif self._is_bms_heartbeat(cmd_func, cmd_id):
                try:
                    msg_bms_heartbeat = delta_3_max_plus_pb2.Delta3MaxPlusBMSHeartBeatReport()
    ...
    def _prepare_data_set_reply_topic(self, raw_data: bytes) -> PreparedData:
        ...
        try:
            ...
            try:
                ...
                _LOGGER.debug("[Delta3MaxPlus] base64 decode failed: %s", e)

            header_msg = delta_3_max_plus_pb2.Delta3MaxPlusSendHeaderMsg()
            header_msg.ParseFromString(raw_data)
            ...
            if header_msg.msg:
                ...
                if pdata:
                    try:
                        ...
                        reply_msg = delta_3_max_plus_pb2.Delta3MaxPlusSetReply()
                        ...
                        _LOGGER.debug(f"Failed to parse as Delta3MaxPlusSetReply: {e}")
        except Exception as e:
